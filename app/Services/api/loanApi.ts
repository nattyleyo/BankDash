...
const API_URL = "https://bank-dash-aykd.onrender.com/active-loans"; // Adjust this to match your actual API base URL
...
class TransactionService {
  ...
  public static applyLoan(accessToken: string): Promise<LoanDetail> {
    return handleRequest("POST", `${API_URL}`, undefined, accessToken, false);
  }
}
